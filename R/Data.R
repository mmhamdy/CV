experience <- tribble(
  ...
  "Senior Researcher", "Natural Wellness Group", "May", 2016, "January", 2019, "Nasr City", "Reviewing collected data and writing analysis reports.",
...
training <- tribble(
  ...
  "Visualizing Time Series Data in R", "DataCamp", "April 2021",
